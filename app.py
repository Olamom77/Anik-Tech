...
def init_db():
    ...
    c.execute("INSERT OR IGNORE INTO admins (username,password,name) VALUES (?,?,?)",
              ('admin', hash_pw('Adeyinka77'), 'Abdulmalik Abdulgafar'))
    # Seed student
...
def pwa_manifest():
    ...
    return jsonify({
        ...
        "description": "Official app for Anik Tech School — student portal, announcements, grades and more.",
        "start_url": "/", "display": "standalone",
        "background_color": "#185FA5", "theme_color": "#185FA5",
        "orientation": "portrait-primary", "scope": "/", "lang": "en",
        "categories": ["education"],
        "icons": [
            {"src": f"/static/icons/icon-{s}x{s}.png", "sizes": f"{s}x{s}",
        ...
        "shortcuts": [
            ...
            {"name":"Programs","url":"/programs","icons":[{"src":"/static/icons/icon-96x96.png","sizes":"96x96"}]},
        ]
    })
